...
export class Backend implements backendInterface {
    ...
    async addTask(arg0: bigint, arg1: bigint, arg2: string): Promise<Task> {
        if (this.processError) {
            try {
    ...
    async addWorkflow(arg0: bigint, arg1: string): Promise<Workflow> {
        if (this.processError) {
            try {
                const result = await this.actor.addWorkflow(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async assertUserAccess(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assertUserAccess(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
