...
export interface Task { 'id' : bigint, 'description' : string }
...
export interface _SERVICE {
  ...
  'addTask' : ActorMethod<[bigint, bigint, string], Task>,
  'addWorkflow' : ActorMethod<[bigint, string], Workflow>,
  'assertUserAccess' : ActorMethod<[Principal, bigint], undefined>,
